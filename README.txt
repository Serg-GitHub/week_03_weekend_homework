...
I have developed a rock, paper, scissors web application using html, python, jinja and css inside a flask web framework.

MVP: The initial brief (minimum viable product) was to create an application allowing a user to play a game of rock, paper, scissors by entering a path inside the browser such as /rock/scissors and return the string "Player 1 wins by playing rock" to the page.
